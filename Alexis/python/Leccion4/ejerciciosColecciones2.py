...
# 2 lista de palabras de aparecen en la primera lista, pero no en la segunda
...
print(f"lista de palabras que aparecen en las lista: {union}")
...
print(f"lista de palabras que aparecen en ambas lineas: {interseccion}")
