...
/*
Ejericio 3: Leer 5 numeros, guardarlos en un arreglo y a continuacion realizar la media de los numeros positivos, la media de los negativos y contar en numero de ceros
 */
public class Arreglos_Ejercicio_3 {
    public static void main(String[] args) {
        ...
        if(conteo_negativos == 0){
            System.out.println("\nNo se puede sacar la meida de los numeros negativos");
        }
