# Ejercicios 01: Crear una funcion para sumar los valores recibidos de tipo numericos,
...
def sumar_valor(*args): # recibimos una cantidad de parametros indefiinidos
    resultado = 0
