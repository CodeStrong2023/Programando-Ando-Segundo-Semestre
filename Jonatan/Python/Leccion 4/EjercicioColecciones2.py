...
union = list(conjunto1 | conjunto2)#con el simbolo | unimos las dos listas
solo1 = list(conjunto1 - conjunto2)#solo mostramos el conjunto 1
solo2 = list(conjunto2 - conjunto1)#solo mostramos el conjunto2
interceccion = list(conjunto1 & conjunto2)#mostramos ambas listas
...
print(f"lista de palabras que aparecen en ambas listas: {interceccion}")